#!/usr/bin/env python3
"""scar-1833: seal binds the held outside inputs at the end and refuses escaping paths.

WHY. scar-1831 made seal read every input outside the round from a held copy. The adversarial
