#!/usr/bin/env python3
"""scar-1808: seal measures a SNAPSHOT, so what is measured is what is sealed.
    ...
    def test_writing_a_passing_stylesheet_into_the_snapshot_does_not_seal_a_failing_round(self):
        ...
        def during(proc):
            while proc.poll() is None:
                # the held tree mirrors each file at its own absolute path (scar-1831), so the round
