#!/usr/bin/env python3
"""scar-1837: seal's browser producers refuse any request outside the served round.
...
in scar-1836 (three green pages screenshotted red). Here: the round's own stylesheet sets 9px text,
