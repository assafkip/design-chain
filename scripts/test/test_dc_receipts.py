...
And scar-1808 (final review, finding-7): seal wrote a round digest that nothing ever read, so a
stylesheet swapped AFTER the seal left the round COMPLETE.

Every test here drives the REAL gate at its tracked path (verify contract 2, scar-1810). The
