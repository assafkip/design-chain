#!/usr/bin/env python3
"""scar-1811: the chain reads the snapshot, not the disk.

WHY. scar-1808 made seal measure a snapshot and compare every file at the end, and left one
...
before the final compare was caught by neither read (scar-1808 finding-10).
...
class ReadsThatLeaveTheRoundResolveLive(Base):
    ...
    def test_the_round_an_implements_names_is_found_beside_the_round(self):
        # Only that it RESOLVES. Whether it counts as sealed is scar-1831's: a '{}' receipt no
...
class OneRoundOneConfig(Base):
    """scar-1811 review round 1 (40e6cd3d), Sana's triage 2026-09-19."""
